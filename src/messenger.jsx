...
function Messenger() {
  return (
    <div className="maindiv">
      ...
      <footer> 
        <div className="chats"><FontAwesomeIcon className="chats" icon={faComment} />
        <br />
        <p>
          Chats</p></div>
        <div className="people"><FontAwesomeIcon className="people" icon={faUserGroup}/><br />
        <p>People</p></div>
        <div className="stories"><img src="https://cdn.iconscout.com/icon/free/png-256/free-facebook-story-icon-download-in-svg-png-gif-file-formats--logo-menu-application-social-media-pack-user-interface-icons-6147390.png?f=webp&w=256" alt="" /><br />
        <p>stories</p></div>
      </footer>
    </div>
  );
